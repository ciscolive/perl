...
VIMRuntime::make_get_set('ComputeResource', 'resourcePool', 'host', 'datastore', 'network', 'summary', 'environmentBrowser', 'configurationEx', 'lifecycleManaged');
...
VIMRuntime::make_get_set('Folder', 'childType', 'childEntity', 'namespace');
...
VIMRuntime::make_get_set('ResourcePool', 'summary', 'runtime', 'owner', 'resourcePool', 'vm', 'config', 'namespace', 'childConfiguration');
...
##################################################################################
package StorageQueryManager;
our @ISA = qw(ViewBase StorageQueryManagerOperations);

VIMRuntime::make_get_set('StorageQueryManager');
...
##################################################################################
package HostAssignableHardwareManager;
our @ISA = qw(ViewBase HostAssignableHardwareManagerOperations);

VIMRuntime::make_get_set('HostAssignableHardwareManager', 'binding', 'config');

our @property_list = (
   ['binding', 'HostAssignableHardwareBinding', 'true'],
   ['config', 'HostAssignableHardwareConfig', undef],
);
sub get_property_list {
   my $class = shift;
   my @super_list = $class->SUPER::get_property_list();
...
##################################################################################
package VirtualMachineGuestCustomizationManager;
our @ISA = qw(ViewBase VirtualMachineGuestCustomizationManagerOperations);

VIMRuntime::make_get_set('VirtualMachineGuestCustomizationManager');
...
sub SetCryptoMode {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('SetCryptoMode', %args));
   return $response
}
...
sub RetrieveFreeEpcMemory {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RetrieveFreeEpcMemory', %args));
   return $response
}
...
##################################################################################
package StorageQueryManagerOperations;
sub QueryHostsWithAttachedLun {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('QueryHostsWithAttachedLun', %args));
   return $response
}
...
sub DisableAlarm {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DisableAlarm', %args));
   return $response
}

sub EnableAlarm {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('EnableAlarm', %args));
   return $response
}
...
sub CryptoManagerHostDisable {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('CryptoManagerHostDisable', %args));
   return $response
}
...
sub IsKmsClusterActive {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('IsKmsClusterActive', %args));
   return $response
}

sub SetDefaultKmsCluster {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('SetDefaultKmsCluster', %args));
   return $response
}

sub GetDefaultKmsCluster {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('GetDefaultKmsCluster', %args));
   return $response
}

sub QueryCryptoKeyStatus {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('QueryCryptoKeyStatus', %args));
   return $response
}

sub RegisterKmsCluster {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RegisterKmsCluster', %args));
   return $response
}

sub UnregisterKmsCluster {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UnregisterKmsCluster', %args));
   return $response
}

sub ListKmsClusters {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ListKmsClusters', %args));
   return $response
}
...
##################################################################################
package HostAssignableHardwareManagerOperations;
sub DownloadDescriptionTree {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DownloadDescriptionTree', %args));
   return $response
}

sub RetrieveDynamicPassthroughInfo {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RetrieveDynamicPassthroughInfo', %args));
   return $response
}

sub UpdateAssignableHardwareConfig {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UpdateAssignableHardwareConfig', %args));
   return $response
}
...
sub EnableClusteredVmdkSupport {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('EnableClusteredVmdkSupport', %args));
   return $response
}

sub DisableClusteredVmdkSupport {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DisableClusteredVmdkSupport', %args));
   return $response
}
...
sub ChangePassword {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ChangePassword', %args));
   return $response
}
...
sub UpdateHppMultipathLunPolicy {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UpdateHppMultipathLunPolicy', %args));
   return $response
}
...
sub MarkPerenniallyReserved {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('MarkPerenniallyReserved', %args));
   return $response
}

sub MarkPerenniallyReservedEx_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('MarkPerenniallyReservedEx_Task', %args));
   return $response
}

sub MarkPerenniallyReservedEx {
   my ($self, %args) = @_;
   return $self->waitForTask($self->MarkPerenniallyReservedEx_Task(%args));
}

sub CreateNvmeOverRdmaAdapter {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('CreateNvmeOverRdmaAdapter', %args));
   return $response
}

sub RemoveNvmeOverRdmaAdapter {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RemoveNvmeOverRdmaAdapter', %args));
   return $response
}

sub DiscoverNvmeControllers {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DiscoverNvmeControllers', %args));
   return $response
}

sub ConnectNvmeController {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('ConnectNvmeController', %args));
   return $response
}

sub DisconnectNvmeController {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('DisconnectNvmeController', %args));
   return $response
}
...
##################################################################################
package VirtualMachineGuestCustomizationManagerOperations;
sub CustomizeGuest_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('CustomizeGuest_Task', %args));
   return $response
}

sub CustomizeGuest {
   my ($self, %args) = @_;
   return $self->waitForTask($self->CustomizeGuest_Task(%args));
}

sub StartGuestNetwork_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('StartGuestNetwork_Task', %args));
   return $response
}

sub StartGuestNetwork {
   my ($self, %args) = @_;
   return $self->waitForTask($self->StartGuestNetwork_Task(%args));
}

sub AbortCustomization_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('AbortCustomization_Task', %args));
   return $response
}

sub AbortCustomization {
   my ($self, %args) = @_;
   return $self->waitForTask($self->AbortCustomization_Task(%args));
}
...
sub HostUpdateVStorageObjectMetadata_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('HostUpdateVStorageObjectMetadata_Task', %args));
   return $response
}

sub HostUpdateVStorageObjectMetadata {
   my ($self, %args) = @_;
   return $self->waitForTask($self->HostUpdateVStorageObjectMetadata_Task(%args));
}

sub HostRetrieveVStorageObjectMetadata {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('HostRetrieveVStorageObjectMetadata', %args));
   return $response
}

sub HostRetrieveVStorageObjectMetadataValue {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('HostRetrieveVStorageObjectMetadataValue', %args));
   return $response
}
...
sub UpdateVStorageObjectCrypto_Task {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('UpdateVStorageObjectCrypto_Task', %args));
   return $response
}

sub UpdateVStorageObjectCrypto {
   my ($self, %args) = @_;
   return $self->waitForTask($self->UpdateVStorageObjectCrypto_Task(%args));
}
...
sub RetrieveSnapshotDetails {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('RetrieveSnapshotDetails', %args));
   return $response
}

sub VstorageObjectVCenterQueryChangedDiskAreas {
   my ($self, %args) = @_;
   my $response = Util::check_fault($self->invoke('VstorageObjectVCenterQueryChangedDiskAreas', %args));
   return $response
}
