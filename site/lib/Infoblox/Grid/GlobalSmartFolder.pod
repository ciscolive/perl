...
Use this method to search for Global Smart Folder objects in the Infoblox appliance. See L<Infoblox::Session-E<gt>search()|Infoblox::Session/search()/> for parameters and return values.
...
B<#Preparation prior to an GlobalSmartFolder object insertion>
...
B<#Create a GlobalSmartFolder object>
...
B<#Search for a GlobalSmartFolder>
...
B<#Get and modify a GlobalSmartFolder object>
...
B<#Remove a GlobalSmartFolder object>
